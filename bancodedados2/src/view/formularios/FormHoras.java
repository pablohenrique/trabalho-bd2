...
public class FormHoras extends JDialog implements ActionListener{
    ...
    private JLabel horas = new JLabel();
    private JComboBox tipo = new JComboBox();
    private JButton btnOK = new JButton("OK");
    
    public FormHoras(){
        super(Principal.janela,"Encontre os empregados que trabalham mais/menos horas", true);
        ...
        tipo.addItem("Mais Horas em todos Projetos");
        tipo.addItem("Menos Horas em todos Projetos");
    ...
    public void setEmpregado(Empregado e) {
        emp = e;
        horas.setText(e.getSalarioString());
