...
" FROM cia.trabalha_em AS t, cia.empregado AS e, cia.projeto AS p, cia.departamento AS d";
    ...
    private Object criarObjetoTemplate() throws Exception{
    ...
    public void deletarEmpregadoProjeto(String ssn, int numero) throws SQLException{
    ...
    public Object buscarEmpregadoProjeto(String ssn, int projeto) throws SQLException, Exception {
